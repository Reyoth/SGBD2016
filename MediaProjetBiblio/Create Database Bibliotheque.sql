...
CREATE TABLE Generer(
	...
	RES_Id INT  NOT NULL ,
	EMP_Id INT  NOT NULL ,
	CONSTRAINT prk_constraint_Generer PRIMARY KEY NONCLUSTERED (RES_Id,EMP_Id)
);
...
ALTER TABLE Generer ADD CONSTRAINT FK_Generer_RES_Id FOREIGN KEY (RES_Id) REFERENCES Reservation(RES_Id);
ALTER TABLE Generer ADD CONSTRAINT FK_Generer_EMP_Id FOREIGN KEY (EMP_Id) REFERENCES Emprunt(EMP_Id);
