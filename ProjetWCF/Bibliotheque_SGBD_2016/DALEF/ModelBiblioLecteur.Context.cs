...
namespace DALEF
{
    ...
    public partial class SGBD2016_BibliothequeEntities : DbContext
    {
        ...
        public virtual ObjectResult<LEC_Login_Result> LEC_Login(string userName, string password)
        {
            ...
            try
            {
                return ((IObjectContextAdapter) this).ObjectContext.ExecuteFunction<LEC_Login_Result>("LEC_Login",
        ...
        public virtual ObjectResult<LEC_GetUserData_Result> LEC_GetUserData(Nullable<int> userId)
        {
            ...
            return
                ((IObjectContextAdapter) this).ObjectContext.ExecuteFunction<LEC_GetUserData_Result>("LEC_GetUserData",
                    userIdParameter);
        }

        public virtual int LEC_UpdateUserData(Nullable<int> userId, string lEC_Nom, string lEC_Prenom, string lEC_Sexe,
            string lEC_Adresse, string lEC_Ville, Nullable<int> lEC_CodePostal,
            Nullable<System.DateTime> lEC_DateDeNaissance, string lEC_UserName, string lEC_Password, string lEC_Photo)
        {
            try
            {
                var userIdParameter = userId.HasValue ?
