        ...
        private void SuivantBt_Click(object sender, EventArgs e)
        {
            switch (ConnectionCombobox.SelectedItem.ToString())
            {
                ...
                case "Lecteur": LecteurLogin LctLogin = new LecteurLogin();
                                ...
                                break;
                case "" :
                                MessageBox.Show("Erreur Champs vide","Choisissez d'abord le mode de connexion avant de cliquer sur le bouton suivant.",MessageBoxButtons.OK, MessageBoxIcon.Error);
                                break;
            }
        }
    }
